    ...
    <div class="sidebar">
     ...
     <!-- Sidebar Menu -->
              <nav class="mt-2">
                  ...
                  <li class="nav-item">
                    <a href="{{ route('admin.alternatif_kriteria.index') }}" class="nav-link">                        <i class="nav-icon fas fa-th"></i>
                        <p>
                            Data
                        </p>
                    </a>            
              ...
              <li class="nav-item">
                <a href="{{ route('admin.perhitungan.calculate') }}" class="nav-link">
                    <i class="nav-icon fas fa-th"></i>
                    <p>
                        Normalisasi
                    </p>
            ...
            <li class="nav-item">
              <a href="{{ route('admin.perhitungan.ranking') }}" class="nav-link">
