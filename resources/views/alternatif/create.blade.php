                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="kode" class="form-control" id="exampleInputNama" placeholder="Masukkan kode">
                                @error('kode')
                                    <small>{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" name="kontak" class="form-control" id="exampleInputPassword1" placeholder="Masukkan kontak">
                                @error('password')
                                    <small>{{ $message }}</small>
                                @enderror
                            </div>
